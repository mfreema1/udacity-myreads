...
import './App.css'
import * as startingBookSet from './bookStore'
          ...
          <Route exact path="/" render={() => (
            <div className="list-books">
              ...
              <div className="list-books-content">
                <div>
                  <Section headerText="Currently Reading"/>
...
class ListOfBooks extends React.Component {
  ...
  state = {
    books : startingBookSet.filter(function(book){
      return book.section == this.props.sectionName;
    })
  }

  render() {
    const booksInSection = this.state.books.map(book =>
